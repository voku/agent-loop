...
final readonly class InitCli
{
    ...
    private const array COMMAND_HELP = [
        ...
        'sync-instructions' => [
            ...
            'description' => 'Update the agent-loop-owned AGENTS.md block and maintained compatibility/import shims.',
            'notes' => [
                'Only managed marker blocks are changed; project-owned text outside them is preserved. Use --dry-run to preview updates.',
                'Claude Code can consume AGENTS.md directly; its CLAUDE.md import remains a compatibility shim.',
            ],
        ],
        'sync-tools' => [
    ...
    private function printUsage(int $exitCode, string $unknownCommand = ''): int
    {
        ...
        Commands:
          ...
          sync-instructions Update only agent-loop-owned marker blocks in AGENTS.md and maintained compatibility/import shims; preserve project-owned instructions outside the markers.
