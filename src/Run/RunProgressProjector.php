...
final readonly class RunProgressProjector
{
    ...
    public function project(string $taskId, string $mode, array $references, array $disagreements): RunProgressProjection
    {
        ...
        $steps = [
            ...
            $this->step('recall_outcomes', 'Recall outcomes', $recallOutcomesCurrent ? RunProgressStep::STATUS_CURRENT : RunProgressStep::STATUS_NOT_APPLICABLE, 'agent-learning', $recallOutcomesCurrent ? $this->reason($references, 'verification') : null),
