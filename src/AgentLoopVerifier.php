...
final class AgentLoopVerifier
{
     ...
     * tasks/ or session directory means the baseline premise this command
     * exists to confirm (a task exists, a session is tracking it) doesn't
     * hold. checkBoard()'s optional typed board source and checkLearningRoot()'s
