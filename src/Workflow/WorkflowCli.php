...
Commands:
  ...
  handoff   Compile a self-contained TODO/card handoff prompt from the current bounded Session projection plus durable Contract evidence; the acting agent still updates the existing task owner.
...
Ownership:
  ...
  The repository's task/board owner owns the durable handoff text; `workflow handoff` only compiles the prompt used to update it.
