...
| Self-review close-out | An exploratory blind-spot review may warn while work is open. Before close, log recall outcome, record an explicit `review blindspots` checkpoint, then require the final blind-spot review to be clean. | `tools/self-shape-dogfood.php` |
