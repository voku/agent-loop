...
final class CompactLayoutIntegrationTest extends TestCase
{
    ...
    public function testCompactScaffoldKeepsWorkflowStateUnderOneDirectory(): void
    {
        $scaffold = $this->dispatch(['agent-loop', 'init', 'scaffold', '--layout=compact']);
        ...
        self::assertSame('compact', $config['layout'] ?? null);
