...
final class RepositoryHealthTest extends TestCase
{
    ...
    public static function cases(): iterable
    {
        ...
        yield 'slop-scan before repair' => [[
            ...
            'renovate' => ['config_path' => null, 'dashboard' => false, 'pr_history' => false], 'peers' => $peers,
        ...
        yield 'simple_html_dom ineffective fork config' => [[
            ...
            'renovate' => ['config_path' => '.github/renovate.json', 'dashboard' => false, 'pr_history' => false], 'peers' => $peers,
        ...
        yield 'configured but not yet observed' => [[
            'repository' => 'voku/agent-loop', 'composer' => true, 'fork' => false, 'issues_enabled' => true,
            'renovate' => ['config_path' => 'renovate.json', 'dashboard' => false, 'pr_history' => false], 'peers' => $peers,
        ], 'configured', []];

        yield 'repaired fork with activity' => [[
            'repository' => 'voku/slop-scan', 'composer' => true, 'fork' => true, 'issues_enabled' => true,
            'renovate' => ['config_path' => 'renovate.json', 'fork_processing' => 'enabled', 'dashboard' => true, 'pr_history' => true], 'peers' => $peers,
        ], 'healthy', []];
