...
{
    /**
     * The Slice E falsification pass found the two ordinary-path skills still
     * carrying an old phase machine and discovery-before-approval choreography.
     * Guard the concrete shapes that actually drifted; this is not a prose
     * policy engine.
     */
    public function testOrdinaryHostSkillsRouteToCanonicalLifecycleResults(): void
    {
